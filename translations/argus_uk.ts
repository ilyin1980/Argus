...
<context>
    ...
    <message>
        ...
        <translation>Argus — Довідка</translation>
    </message>
    <message>
...
Типово це .argus усередині папки з картинками; вкажіть іншу,
...
марний для пошуку дрібного об'єкта всередині скріншота.</translation>
    ...
    <message>
        ...
        <translation>Про Argus</translation>
    </message>
    <message>
        ...
        <translation>&lt;h3&gt;Argus %1&lt;/h3&gt;&lt;p&gt;Знаходить, які асети присутні на скріншоті й де саме; а також групує дублікати в папці.&lt;/p&gt;&lt;p&gt;Постачається як два виконуваних файли, зібрані з однієї бібліотеки: &lt;b&gt;argus-gui&lt;/b&gt; та консольний &lt;b&gt;argus&lt;/b&gt;.&lt;/p&gt;&lt;p&gt;Натисніть &lt;b&gt;F1&lt;/b&gt;, щоб відкрити посібник.&lt;/p&gt;</translation>
    </message>
    <message>
